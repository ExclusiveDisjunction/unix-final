...
pub fn read_file_contents<P>(path: P) -> Result<String, std::io::Error>
where
    P: AsRef<Path>,
{
...
pub fn send_buffer<T>(src: &[u8], sock: &mut T) -> Result<(), std::io::Error>
where
    T: Write,
{
...
pub fn receive_buffer<T>(dest: &mut Vec<u8>, sock: &mut T) -> Result<(), std::io::Error>
where
    T: Read,
{
    dest.clear();
...
pub async fn read_file_contents_async<P>(path: P) -> Result<String, std::io::Error>
where
    P: AsRef<Path>,
{
...
pub async fn send_buffer_async<T>(src: &[u8], sock: &mut T) -> Result<(), std::io::Error>
where
...
pub async fn receive_buffer_async<T>(dest: &mut Vec<u8>, sock: &mut T) -> Result<(), std::io::Error>
where
